package io.demo.crm.common.logger.aspect;

import io.demo.crm.common.util.JSON;
import io.demo.crm.common.util.LogUtils;
import io.demo.crm.common.logger.annotation.Log;
import io.demo.crm.common.logger.constants.LogType;
import io.demo.crm.common.logger.dto.LogDTO;
import io.demo.crm.common.logger.service.LogService;
...
public class LogAspect {
     ...
     * 定义切点，拦截带有 @Log 注解的方法
     */
    @Pointcut("@annotation(io.demo.crm.common.logger.annotation.Log)")
