...
import io.demo.crm.common.interceptor.MybatisInterceptor;
import io.demo.crm.common.interceptor.UserDesensitizationInterceptor;
 ...
 */
@Configuration
@MapperScan(basePackages = {"io.demo.crm.modules.*.mapper", "io.demo.crm.modules.*.mapper.ext"}, sqlSessionFactoryRef = "sqlSessionFactory")
